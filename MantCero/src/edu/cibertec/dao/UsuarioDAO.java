...
import edu.cibertec.util.Conexion;
...
public class UsuarioDAO implements UsuarioService{
	...
	public List<UsuarioJPA> ListaUsuarioNivel(String nivel) throws Exception {
		...
		Open();
		try {
//			new AlumnoJPA().getEspecialidadBean().getIdEspecialidad()
			Query q=em.createQuery("select u from UsuarioJPA u where u.especialidadBean.idEspecialidad= :cod");
